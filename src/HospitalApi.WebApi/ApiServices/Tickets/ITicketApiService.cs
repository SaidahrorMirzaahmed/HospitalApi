...
public interface ITicketApiService
{
    ...
    Task<IEnumerable<TicketViewModelModel>> GetAllPaidAsync(PaginationParams @params, Filter filter, string search = null);

    Task<IEnumerable<TicketViewModelModel>> GetAllUnpaidAsync(PaginationParams @params, Filter filter, string search = null);
    ...
    Task<IEnumerable<TicketViewModelModel>> GetPaidByClientIdAsync(long id, [FromQuery] PaginationParams @params, [FromQuery] Filter filter, [FromQuery] string search = null);

    Task<IEnumerable<TicketViewModelModel>> GetUnpaidByClientIdAsync(long id, [FromQuery] PaginationParams @params, [FromQuery] Filter filter, [FromQuery] string search = null);

    Task<TicketViewModelModel> CreateAsync(long clientId, IEnumerable<TicketCreateModel> ticketCreateModels);

    Task<TicketViewModelModel> UpdateAsync(long id, bool isPaid);
