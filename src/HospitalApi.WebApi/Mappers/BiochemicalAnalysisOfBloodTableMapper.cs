...
{
    private readonly static Dictionary<int, BiochemicalAnalysisOfBloodTableResultViewModel> _keyValuePairs = new Dictionary<int, BiochemicalAnalysisOfBloodTableResultViewModel>
    {
    ...
    public static BiochemicalAnalysisOfBloodTableViewModel GetBiochemicalAnalysisOfBloodTableView(BiochemicalAnalysisOfBloodTable table)
    {
        var view = new Dictionary<int, BiochemicalAnalysisOfBloodTableResultViewModel>(_keyValuePairs);
        ...
        return new BiochemicalAnalysisOfBloodTableViewModel
        {
            Id = table.Id,
            Items = view.Values
        };
    ...
    public static BiochemicalAnalysisOfBloodTable CreateBiochemicalAnalysisOfBloodTable(long id, BiochemicalAnalysisOfBloodTableUpdateModel updateModel)
    {
